"""Numeric distribution models for forecasting."""
...
class NumericDefaults:
    """Default values for numeric distributions."""
    ...
    def get_max_pmf_value(
        ...
        """Calculate maximum PMF value based on CDF size."""
...
class NumericDistribution(BaseModel):
    """Represents a numeric probability distribution."""
    ...
    def _check_percentiles_increasing(self) -> None:
        """Check that percentiles are strictly increasing."""
        percentiles = self.declared_percentiles
    ...
    def _check_percentile_spacing(self) -> None:
        """Check that percentiles are sufficiently spaced."""
        percentiles = self.declared_percentiles
        for i in range(len(percentiles) - 1):
    ...
    def _check_and_update_repeating_values(
        ...
        """Check for and handle repeating values."""
    ...
    def _percentile_list_to_dict(
        ...
        """Convert percentile list to dictionary."""
        return {
            (
    ...
    def _dict_to_percentile_list(
        ...
        """Convert dictionary to percentile list."""
        return [
            Percentile(
    ...
    def _add_explicit_upper_lower_bound_percentiles(
        ...
        """Add explicit upper and lower bound percentiles."""
        open_upper_bound = self.open_upper_bound
        open_lower_bound = self.open_lower_bound
